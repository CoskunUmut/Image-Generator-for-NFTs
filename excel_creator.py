...
class ExcelCreator:
    ...
    def create_occurrences_table(self):
        ...
        for image_module in self.images_module:
            for image_feature in image_module.images_feature:
                row = row + 1
                worksheet.write(row, 0, image_feature.feature_name)
                ...
                print(f"{image_feature.feature_name} was used: {image_feature.feature_actually_used} times!")
        workbook.close()
    ...
    def create_NFT_table(self):
        ...
        for NFT in self.NFTs:
            ...
            worksheet.merge_range(row-1, 1, row, 1, NFT.image_path, merge_format)
            col = 0
